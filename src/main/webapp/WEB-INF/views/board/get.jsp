...
<jsp:include page="../includes/header.jsp" />
            ...
            <div class="container-fluid">
			  ...
			  <div class="form-group">
			    ...
			    <input type="text" class="form-control" placeholder="Enter title" id="bno" name="bno" readonly value="${board.bno}">
			  </div>
			  <div class="form-group">
...
$(function() {
	...
	$(".chat").on("click", "li", function() { // 작성된 댓글 클릭시 나타나는 화면
	...
	$("#modalFooter button").eq(2).click(function() {
		...
		replyService.add(obj, function(result) {
			...
			replyService.get(result, function(data) {
				$(".chat").prepend(getReplyLiStr(data));  // 작성한 댓글을 맨 앞으로 보냄
			})
		});
	});

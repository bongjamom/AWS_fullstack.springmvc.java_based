...
<head>
<meta charset="UTF-8">
<title>2023. 4. 11오전 10:45:40</title>
<style>
table {border-collapse: collapse; width: 800px; margin: auto 0;}
...
<body>
	...
	<hr>
	<h4>${member.name}님의 발송 목록</h4>
	<table class="sendList">
	</table>
	<h4>${member.name}님의 수신 목록</h4>
	<table class="receiveList">
	</table>
	<h4>${member.name}님의 수신(미확인) 목록</h4>
	...
	$(function () {
		...
		function getTableText(data) { // 함수 입력값:파라미터, 출력값:return 출력값은 1개
			var str = "<tr>";
			str += "<th>쪽지번호</th>"
			str += "<th>발송자</th>"
			str += "<th>수신자</th>"
